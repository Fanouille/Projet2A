...
//--------------------Ajouter un champ de compétence-------------------------------------------
    $scope.addInput = function(){
        ...
        addInput.innerHTML = input + '<md-input-container flex="20"> <label>Compétences</label> <input type="text" name="competences.third" ng-model="competences.third"> </md-input-container>'
    }
